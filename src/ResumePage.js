  ...
  return (
    <Container>
            ...
            <Card.Body>
              <Row>
                ...
                <Col className="col-9">
                  ...
                  <Row>
                    <Card.Link href="mailto:alexanderjulianty@gmail.com">
                      alexanderjulianty@gmail.com
                    </Card.Link>
                    <p>(858) 281-3589</p>
                    <p>11694 Compass Point Dr. N. #166, San Diego, CA, 92126</p>
                    <a href="https://drive.google.com/file/d/1mfgaA4uw9m8Aq3JhR6XGwM4k4eu3MkUa/view?usp=sharing">
                      PDF version
                    </a>
                  </Row>
                </Col>
      ...
      <Row className="d-flex justify-content-center">
        <Card className="col-9">
          <Card.Body>
            As I believe my strength lies in working others, I am in pursuit of
            a challenging work environment with opportunities to collaborate in
            groups, preferably with an emphasis on programming. Also, having
            opportunities for mentorship is important to me, being either or
          ...
          <Card className="col-9">
            <Card.Body>
              <Row>
                ...
                <Col>
                  <p>
                    C, Python, HTML, CSS, React, LaTeX, R, Microsoft Office
                    Suite
                  </p>
                </Col>
              </Row>
